...
unlink(fs::dir_ls(c("vignettes", "fr/vignettes"), regexp = "\\.log$"))  # logs sometimes generated by PDF rendering of the vignettes
devtools::check(".")

rmarkdown::render("misc/README.Rmd", quiet = TRUE, output_options = list(html_preview = FALSE))
rmarkdown::render("misc/Release_Checklist.Rmd", quiet = TRUE, output_options = list(html_preview = FALSE))
rmarkdown::render("G-Series_in_R_roadmap.Rmd", quiet = TRUE, output_options = list(html_preview = FALSE))
...
rmarkdown::render("index.Rmd", quiet = TRUE, output_options = list(html_preview = FALSE))
rmarkdown::render("fr/index.Rmd", quiet = TRUE, output_options = list(html_preview = FALSE))
rmarkdown::render("index_StatCan.Rmd", quiet = TRUE, output_options = list(html_preview = FALSE))
...
# Copy DESCRIPTION file "as is" to the `fr/` folder (exact same function headers)
...
#install.packages("revdepcheck", type = "source")
