...
R version of Statistics Canada's (StatCan) generalized system **G-Series** initially developed in SAS^®^. This website is devoted to G-Series in R (package gseries). Email us at [g-series@statcan.gc.ca](mailto:g-series@statcan.gc.ca) for information about the SAS^®^ versions. 
...
Finally, the [Get started](./articles/gseries.html) page (top bar) provides general information about G-Series and is available as a vignette in R (`vignette("gseries")`).
