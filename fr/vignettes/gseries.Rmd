...
Alors que les premières versions de G-Séries (v1.04 et v2.0) ont été développées en SAS^®^, le logiciel est désormais offert en libre accès (logiciel libre) depuis la sortie de G-Séries 3.0 (librairie R gseries 3.0.0). Ce projet est consacré à la version de G-Séries offerte en libre accès (librairie R gseries). Écrivez-nous à [g-series@statcan.gc.ca](mailto:g-series@statcan.gc.ca) pour obtenir des informations sur les versions SAS^®^. Les employés de StatCan peuvent également visiter la page Concfluence de G-Séries dans l'intranet de l'agence (cherchez « G-Series | G-Séries » dans Confluence).
